...
1. **palaeoverse**: A community-driven R package to support data preparation and exploration for palaeobiological analyses.  
   1. CRAN: [https://cran.r-project.org/web/packages/palaeoverse/](https://cran.r-project.org/web/packages/palaeoverse/).  
   2. GitHub: [https://github.com/palaeoverse/palaeoverse](https://github.com/palaeoverse/palaeoverse).  

2. **rphylopic**: An R package for fetching, transforming, and visualising PhyloPic silhouettes.  
   1. CRAN: [https://cran.r-project.org/web/packages/rphylopic/](https://cran.r-project.org/web/packages/rphylopic/).  
   2. GitHub: [https://github.com/palaeoverse/rphylopic](https://github.com/palaeoverse/rphylopic).  

3. **sepkoski**: A data R package of Sepkoski's Fossil Marine Animal Genera Compendium (Sepkoski, 2002).  
   1. CRAN: [https://cran.r-project.org/web/packages/sepkoski/](https://cran.r-project.org/web/packages/sepkoski/).  
   2. GitHub: [https://github.com/lewisajones/sepkoski](https://github.com/lewisajones/sepkoski).  

4. **rmacrostrat:** An R package to fetch geologic data from the Macrostrat database.  
   1. CRAN: [https://cran.r-project.org/web/packages/rmacrostrat/](https://cran.r-project.org/web/packages/rmacrostrat/).  
   2. GitHub: [https://github.com/palaeoverse/rmacrostrat](https://github.com/palaeoverse/rmacrostrat).  
